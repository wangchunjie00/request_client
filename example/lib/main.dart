...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    print(RequestConfig.instance.baseUrl);
    testConfgi();
  }

  void testConfgi() async {
    var res = await RequestClient.instance.request("/sendEmailCode",
        method: RequestType.POST,
        data: {"email": "m15815511753@163.com", "sendType": "reg"});
    print(res);
  }
